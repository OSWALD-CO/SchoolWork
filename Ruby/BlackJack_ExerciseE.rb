...
class Game
  ...
  def retrieve_files
    ...
    if RUBY_PLATFORM =~ /win32/ then
      ...
      $help_file = File.read('C:\Users\clayo\OneDrive\Desktop\Assignment 8.1 - Clayton Oswald\BJHelp.txt')
      $welcome_file = File.read('C:\Users\clayo\OneDrive\Desktop\Assignment 8.1 - Clayton Oswald\BJWelcome.txt')
      $credits_file = File.read('C:\Users\clayo\OneDrive\Desktop\Assignment 8.1 - Clayton Oswald\BJCredits.txt')
    else
      $help_file = File.read('/Users/clayo/OneDrive/Desktop/Assignment 8.1 - Clayton Oswald/BJHelp.txt')
      $welcome_file = File.read('/Users/clayo/OneDrive/Desktop/Assignment 8.1 - Clayton Oswald/BJWelcome.txt')
      $credits_file = File.read('/Users/clayo/OneDrive/Desktop/Assignment 8.1 - Clayton Oswald/BJCredits.txt')
    end
  ...
  def write_log_file(msg)
    ...
    #Determine if the game is running on Windows or Mac OS X, UNIX, Linux
    if RUBY_PLATFORM =~ /win32/ then
      outFile = File.new('C:\Users\clayo\OneDrive\Desktop\Assignment 8.1 - Clayton Oswald\temp\BJLog.txt', "a")  #Open the log file
      outFile.puts msg                              #Write a line of text
      outFile.close                                 #Close the log file
    else
      outFile = File.new('/Users/clayo/OneDrive/Desktop/Assignment 8.1 - Clayton Oswald/tmp/BJLog.txt', "a")     #Open the log file
      outFile.puts msg                              #Write a line of text
      outFile.close                                 #Close the log file
    end
  ...
  def remove_log_file
    ...
    if RUBY_PLATFORM =~ /win32/ then
      ...
      if File.exist?('C:\Users\clayo\OneDrive\Desktop\Assignment 8.1 - Clayton Oswald\temp\BJLog.txt') then
        File.delete('C:\Users\clayo\OneDrive\Desktop\Assignment 8.1 - Clayton Oswald\temp\BJLog.txt')
      end
    else
      #Delete the log file only if it exists
      if File.exist?('/Users/clayo/OneDrive/Desktop/Assignment 8.1 - Clayton Oswald/tmp/BJLog.txt') then
        File.delete('/Users/clayo/OneDrive/Desktop/Assignment 8.1 - Clayton Oswald/tmp/BJLog.txt')
      end
    end
