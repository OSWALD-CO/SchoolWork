#-------------------------------------------------------------------------
#
#Script Name: NumberGuessing_ExerciseE.rb
#Version: 1.0
...
#and finish the Number Guessing assignemnt.
#
#-------------------------------------------------------------------------
...
elsif #The player wants to play the game
