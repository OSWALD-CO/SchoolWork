...
class Game
  ...
  def play_game
    ...
    if result == "Player wins! Rock Crushes Scissors!" or result == "Player wins! Paper Covers Rock!" or result == "Player wins! Scissors Cut Paper!"
        $wins += 1
    elsif result == "Computer wins! Paper Covers Rock!" or result == "Computer wins! Scissors Cut Paper!" or result == "Computer wins! Rock Crushes Scissors!"
        $lost += 1
    else
        $ties += 1
    end
  ...
  def get_player_move
    ...
    loop do  #Loop forever
      ...
      break if @choice  =~ /Rock|Paper|Scissors/i or @choice =~ /R|P|S/i
  ...
  def analyze_results(player, computer)
    ...
    if player == "ROCK" or player == "R" then
      ...
      return "You both picked the same thing!" if computer == "ROCK"     
    ...
    if player == "PAPER" or player == "P" then
      ...
      return "You both picked the same thing!" if computer == "PAPER"     
    ...
    if player == "SCISSORS" or player == "S" then
      ...
      return "You both picked the same thing!" if computer == "SCISSORS"     
  ...
  def display_results(player, computer, result)
    ...
    puts "\n\n\t\t\tResult:           " + result
    puts "\n\n\t\t\tYou have Won:     " + $wins.to_s
    puts "\n\n\t\t\tYou have Lost:    " + $lost.to_s
    puts "\n\n\t\t\tYou have Tied:    " + $ties.to_s
    puts "\n\n\t\t\t================================"
    puts "\n\n"
    print "Press Enter to continue. "
    gameCount
  ...
  def gameCount
    $gameCount += 1
        puts "\nYou have play a total of " + $gameCount.to_s + " game(s)."
    end
